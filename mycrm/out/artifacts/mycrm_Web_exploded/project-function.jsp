        ...
        <td height="26" background="skin/images/newlinebg3.gif">
            <table width="58%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <input type='button' class="coolbg np" onClick="location='project-function-add.jsp';"
                               value='添加新功能'/>
                    </td>
                </tr>
            </table>
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
        ...
        <c:forEach items="${fList}" var="f">
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                ...
                <td><input name="id" type="checkbox" id="id" value="${f.id}" class="np"></td>
                <td>${f.id}</td>
                <td align="center"><a href=''><u>${f.functionname}</u></a></td>
                <td align="center"><a href=''><u>${f.modname}</u></a></td>
                <td align="center"><a href=''><u>${f.title}</u></a></td>
                <td align="center"><a href=''><u>${f.proname}</u></a></td>
                <td>${f.level}</td>
                <td>${f.simpledis}</td>
                <td>${f.detaileddis}</td>
