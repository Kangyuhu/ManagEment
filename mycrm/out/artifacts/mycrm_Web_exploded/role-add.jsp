...
<form name="form2" action="${pageContext.request.contextPath}/auth/saveRole" method="post" id="form18">
 <input type="hidden"  id="sid" name="sids">
...
<script type="text/javascript">
	...
	$("#myButton").click(function () {
		//得到这棵树
		var tobj = $.fn.zTree.getZTreeObj("permissionTree");
		//或得到选中的树节点
		var nodes = tobj.getCheckedNodes(true);
		console.log(nodes);
		var sids = "";
