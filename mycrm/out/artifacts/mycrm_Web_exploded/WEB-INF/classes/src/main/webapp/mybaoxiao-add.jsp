...
<form name="form2" action="${pageContext.request.contextPath}/bx/saveBaoXiao?flag=1" id="form9" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<input type="hidden" value="0" id="bxstatus" name="bxstatus">
		<input type="hidden" value="1" id="empFk" name="empFk">
