...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/email/sendMail" method="post" enctype="multipart/form-data">
            ...
            <td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                ...
                <select name="empFk2">
                    ...
                    <c:forEach items="${emplist}" var="e">
                        <option id="empFk2" value="${e.eid}">${e.ename}</option>
                    </c:forEach>
                </select>
            </td>
        </tr>
