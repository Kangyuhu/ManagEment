...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<td width="15%">附件名称</td>
	<td width="15%">所属项目</td>
	<td width="8%">attdis</td>
	<td width="8%">remark</td>
	<td width="13%">操作</td>
</tr>
 <c:forEach items="${aList}" var="att">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>${att.attdis}</td>
	<td>${att.remark}</td>
	<td><a href="${pageContext.request.contextPath}/att/download?path=${att.path}">下载</a> |
        <a href="${pageContext.request.contextPath}/att/delById?id=${att.id}&newpath=${att.path}">删除</a> |
        <a href="${pageContext.request.contextPath}/att/updateEcho?id=${att.id}">编辑</a> |
        <a href="${pageContext.request.contextPath}/att/look?id=${att.id}">查看详情</a></td>
</tr>
    </c:forEach>
<tr bgcolor="#FAFAF1">
