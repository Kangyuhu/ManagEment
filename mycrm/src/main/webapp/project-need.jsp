                ...
                <tr>
                    ...
                    <td>
                        <input type='button' class="coolbg np"
                               onClick="location='../project-need-add.jsp';"
                               value='添加新项目需求'/>
                    </td>
                </tr>
            </table>
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
        ...
        <c:forEach items="${alist}" var="a">
            ...
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                ...
                <td><fmt:formatDate value="${a.addtime}"></fmt:formatDate></td>
                <td><fmt:formatDate value="${a.updatetime}"></fmt:formatDate></td>
                <td><a href="${pageContext.request.contextPath}/ana/updateEcho?id=${a.id}">编辑</a> |
