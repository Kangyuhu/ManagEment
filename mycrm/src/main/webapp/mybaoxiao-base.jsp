...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='${pageContext.request.contextPath}/bx/addBaoXiao';" value='添加报销' />
 </td>
 </tr>
</table>
</td>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<c:if test="${bs.bxstatus == 0}">
		<td>未审批</td>
		<td><a href="mybaoxiao-edit.jsp?bxid=${bs.bxid}&flag=1">编辑</a> </td>
	</c:if>
	...
	<c:if test="${bs.bxstatus == 2}">
		<td>驳回</td>
		<td><a href="${pageContext.request.contextPath}/bx/getByBaoXiao/?bxid=${bs.bxid}&flag=1">编辑</a> </td>
	</c:if>
</tr>
	</c:forEach>
